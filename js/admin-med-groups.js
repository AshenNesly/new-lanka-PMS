    ...
    tbody.innerHTML = groups.map(group => {
        ...
        return `
            <tr>
                ...
                <td>
                    <a href="admin-inside-med-group.html?id=${group.group_id}&name=${encodeURIComponent(group.med_group_name)}&count=${group.medicine_count}&stock=${group.total_stock}&status=${group.stock_status}" 
