console.log('=== PHARMACIST CUSTOMERS SCRIPT LOADING ===');
...
async function deleteCustomer(customerId, customerName) {
    ...
    try {
        ...
        if (data.success) {
            // Don't show success message as requested in previous fixes
            // Reload current page
...
async function saveCustomer() {
    ...
    try {
        const formData = new FormData();
        formData.append('action', currentEditingCustomerId ? 'update_customer' : 'add_customer');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('=== PHARMACIST CUSTOMERS SYSTEM READY ===');
});

console.log('=== PHARMACIST CUSTOMERS SCRIPT LOADED ===');
