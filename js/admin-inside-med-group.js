    ...
    tbody.innerHTML = medicines.map(medicine => {
        ...
        return `
            <tr>
                ...
                <td>
                    <a href="admin-inside-med.html?id=${medicine.medicine_id}&name=${encodeURIComponent(medicine.medicine_name)}&category=${encodeURIComponent(medicine.category)}&stock=${medicine.stock_left}&price=${encodeURIComponent(formattedPrice)}&brand=${encodeURIComponent(medicine.medicine_brand)}&status=${medicine.status}" 
...
function clearAddMedicineForm() {
    ...
    document.getElementById('addMedicineStock').value = '';
    document.getElementById('addMedicinePrice').value = '';
    document.getElementById('addMedicineBrand').value = '';
    document.getElementById('addMedicineHowToUse').value = '';
    document.getElementById('addMedicineSideEffects').value = '';
}
